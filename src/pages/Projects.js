...
function Projects() {
  return (
    <div className="smartphone:h-full tablet:h-screen flex flex-col justify-between">
      ...
      <div className="bg-white smartphone:mt-16 tablet:mt-0 smartphone:mx-5 tablet:px-[14rem] 2xl:px-[28rem] 3xl:mx-[40rem]">
      ...
      <footer className="text-zinc-400 smartphone:mb-5 tablet:mb-10 smartphone:mx-5 tablet:px-[14rem] 2xl:px-[28rem] smartphone:mt-20 tablet:mt-0 flex smartphone:flex-col tablet:flex-row justify-between 3xl:mx-[40rem]">
